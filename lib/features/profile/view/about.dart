...
class AboutSettingView extends StatefulWidget {
  const AboutSettingView({super.key});

  @override
  State<AboutSettingView> createState() => _AboutSettingViewState();
}

class _AboutSettingViewState extends State<AboutSettingView> {
  @override
