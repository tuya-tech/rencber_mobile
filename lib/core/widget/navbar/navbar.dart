...
class NavbarModel {
  ...
  final List<Widget> _usersItems = [MenuView(), const ErrorView(), const HomeView(), const HomeView(), const HomeView()];
  final List<Widget> _guestItems = [MenuView(), const HomeView(), const HomeView(), const HomeView(), const HomeView()];
